...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #b3d7ec 0%, #32acc3 100%);
        }
    </style>
</head>
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Hero-->
    <div class="py-24">
        <div class="container px-6 mx-auto flex flex-wrap flex-col-reverse md:flex-row items-center md:justify-around">
            <!--Left Col-->
            <div
