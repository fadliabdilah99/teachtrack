<div id="skor"
    ...
    <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/3 p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Skors</h2>
            <button onclick="closeModalskors()"
                class="text-gray-400 hover:text-gray-600">&times;</button>
        </div>

        <div class="card">
            <div class="card-body">
                <form  action="{{ route('skor') }}" method="POST">
                    @csrf
                    <input type="number" name="user_id" id="user_id" hidden>
                    <div class="mb-6">
                        <label for="input-label-with-helper-text" class="block text-sm mb-2 text-gray-400">skor</label>
                    ...
                    <div class="flex justify-end">
                        <button type="button" onclick="closeModalskors()"
